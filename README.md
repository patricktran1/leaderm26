...
| **Sharing one photograph** | Opening a frame puts it in the address bar, so the URL you copy opens on that photograph for whoever you send it to. On a phone, Back closes the viewer rather than leaving the site. With JavaScript off the same link still scrolls to the right frame. |
